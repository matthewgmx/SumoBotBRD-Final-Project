...
commands = [0xa1,0xa2,0xa3,0xa4, 0xa5, 0xa6]
delay = 0.05
...
def handle_button_press(button):
   ...
   if button == BUTTON_A:
        transmitter.transmit(device_addr,0xa1)
        print("COMMANDS",hex(0xa1),"TRANSMITTED.")
        time.sleep(0.1)
     
   elif button == BUTTON_B:
        transmitter.transmit(device_addr,0xa2)
        print("COMMANDS",hex(0xa2),"TRANSMITTED.")
        time.sleep(0.1)

   elif button == BUTTON_X:
        transmitter.transmit(device_addr,0xa3)
        print("COMMANDS",hex(0xa3),"TRANSMITTED.")
        time.sleep(0.1)

   elif button == BUTTON_Y:
        transmitter.transmit(device_addr,0xa4)
        print("COMMANDS",hex(0xa4),"TRANSMITTED.")
        time.sleep(0.1)

   elif button == BUTTON_START:
        transmitter.transmit(device_addr,0xa5)
        print("COMMANDS",hex(0xa5),"TRANSMITTED.")
        time.sleep(0.1)

   elif button == BUTTON_SELECT:
        transmitter.transmit(device_addr,0xa6)
        print("COMMANDS",hex(0xa6),"TRANSMITTED.")
        time.sleep(0.1)
...
def main():
   ...
   while True:
     ...
     time.sleep(delay)  # Delay to prevent overwhelming the output
